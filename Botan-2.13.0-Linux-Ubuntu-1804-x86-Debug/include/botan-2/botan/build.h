...
* 'configure.py --cc=gcc --cpu=x86_32 --cc-abi-flags=-m32 --debug-mode --prefix=/root/.TempData/Botan/dist/Botan-2.13.0-Linux-x86-Debug --without-documentation --link-method=copy'
*
* Target
*  - Compiler: g++ -fstack-protector -m32 -pthread -m32 -std=c++11 -D_REENTRANT -g
*  - Arch: x86_32
*  - OS: linux
*/
...
#define BOTAN_INSTALL_PREFIX R"(/root/.TempData/Botan/dist/Botan-2.13.0-Linux-x86-Debug)"
#define BOTAN_INSTALL_HEADER_DIR R"(include/botan-2)"
#define BOTAN_INSTALL_LIB_DIR R"(/root/.TempData/Botan/dist/Botan-2.13.0-Linux-x86-Debug/lib)"
#define BOTAN_LIB_LINK "-ldl -lrt"
#define BOTAN_LINK_FLAGS "-fstack-protector -m32 -pthread -m32"
