...
* 'configure.py --os=windows --cc=msvc --cpu=x86_32 --debug-mode --prefix=C:\Users\Megam\Dropbox\InsaneData\InsaneSuite\Tools/Botan-2.14.0-Windows-x86-Debug --without-documentation --link-method=copy'
*
* Target
...
#define BOTAN_INSTALL_PREFIX R"(C:\Users\Megam\Dropbox\InsaneData\InsaneSuite\Tools/Botan-2.14.0-Windows-x86-Debug)"
#define BOTAN_INSTALL_HEADER_DIR R"(include/botan-2)"
#define BOTAN_INSTALL_LIB_DIR R"(C:\Users\Megam\Dropbox\InsaneData\InsaneSuite\Tools/Botan-2.14.0-Windows-x86-Debug\lib)"
