...
* 'configure.py --cc=gcc --cpu=x86_64 --prefix=/root/.TempData/Botan/dist/Botan-2.13.0-Linux-x64-Release --without-documentation --link-method=copy'
*
* Target
...
#define BOTAN_INSTALL_PREFIX R"(/root/.TempData/Botan/dist/Botan-2.13.0-Linux-x64-Release)"
#define BOTAN_INSTALL_HEADER_DIR R"(include/botan-2)"
#define BOTAN_INSTALL_LIB_DIR R"(/root/.TempData/Botan/dist/Botan-2.13.0-Linux-x64-Release/lib)"
