...
* 'configure.py --cc=gcc --cpu=x86_64 --debug-mode --prefix=/root/.TempData/Botan/dist/Botan-2.13.0-Linux-x64-Debug --without-documentation --link-method=copy'
*
* Target
*  - Compiler: g++ -fstack-protector -m64 -pthread -std=c++11 -D_REENTRANT -g
*  - Arch: x86_64
*  - OS: linux
*/
...
#define BOTAN_INSTALL_PREFIX R"(/root/.TempData/Botan/dist/Botan-2.13.0-Linux-x64-Debug)"
#define BOTAN_INSTALL_HEADER_DIR R"(include/botan-2)"
#define BOTAN_INSTALL_LIB_DIR R"(/root/.TempData/Botan/dist/Botan-2.13.0-Linux-x64-Debug/lib)"
