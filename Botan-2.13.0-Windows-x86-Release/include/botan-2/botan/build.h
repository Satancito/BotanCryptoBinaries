...
* 'configure.py --os=windows --cc=msvc --cpu=x86_32 --prefix=C:\Users\Megam\Dropbox\InsaneData\InsaneSuite\Tools/../CppLib/Botan-2.13.0-Windows-x86-Release --without-documentation --link-method=copy'
*
* Target
...
#define BOTAN_INSTALL_PREFIX R"(C:\Users\Megam\Dropbox\InsaneData\InsaneSuite\Tools/../CppLib/Botan-2.13.0-Windows-x86-Release)"
#define BOTAN_INSTALL_HEADER_DIR R"(include/botan-2)"
#define BOTAN_INSTALL_LIB_DIR R"(C:\Users\Megam\Dropbox\InsaneData\InsaneSuite\Tools/../CppLib/Botan-2.13.0-Windows-x86-Release\lib)"
