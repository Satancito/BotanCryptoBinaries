...
* 'configure.py --os=windows --cc=msvc --cpu=ARM --prefix=C:\Users\Megam\Dropbox\InsaneData\InsaneSuite\Tools/Botan-2.15.0-Windows-ARM-Release --without-documentation --link-method=copy'
*
* Target
...
#define BOTAN_INSTALL_PREFIX R"(C:\Users\Megam\Dropbox\InsaneData\InsaneSuite\Tools/Botan-2.15.0-Windows-ARM-Release)"
#define BOTAN_INSTALL_HEADER_DIR R"(include/botan-2)"
#define BOTAN_INSTALL_LIB_DIR R"(C:\Users\Megam\Dropbox\InsaneData\InsaneSuite\Tools/Botan-2.15.0-Windows-ARM-Release\lib)"
