...
* 'configure.py --os=windows --cc=msvc --cpu=x86_64 --prefix=C:\Users\Megam\Dropbox\InsaneData\InsaneSuite\Tools/Botan-2.14.0-Windows-x64-Release --without-documentation --link-method=copy'
*
* Target
...
#define BOTAN_INSTALL_PREFIX R"(C:\Users\Megam\Dropbox\InsaneData\InsaneSuite\Tools/Botan-2.14.0-Windows-x64-Release)"
#define BOTAN_INSTALL_HEADER_DIR R"(include/botan-2)"
#define BOTAN_INSTALL_LIB_DIR R"(C:\Users\Megam\Dropbox\InsaneData\InsaneSuite\Tools/Botan-2.14.0-Windows-x64-Release\lib)"
