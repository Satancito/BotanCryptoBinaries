...
* 'configure.py --cc=gcc --cpu=x86_32 --cc-abi-flags=-m32 --prefix=/root/.TempData/Botan/dist/Botan-2.13.0-Linux-x86-Release --without-documentation --link-method=copy'
*
* Target
*  - Compiler: g++ -fstack-protector -m32 -pthread -m32 -std=c++11 -D_REENTRANT -O3
*  - Arch: x86_32
*  - OS: linux
*/
...
#define BOTAN_INSTALL_PREFIX R"(/root/.TempData/Botan/dist/Botan-2.13.0-Linux-x86-Release)"
#define BOTAN_INSTALL_HEADER_DIR R"(include/botan-2)"
#define BOTAN_INSTALL_LIB_DIR R"(/root/.TempData/Botan/dist/Botan-2.13.0-Linux-x86-Release/lib)"
